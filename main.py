...
# Events: Have different numbers to make unique event ID's
...
def draw_window(red, yellow, red_bullets, yellow_bullets, red_health, yellow_health):
    ...
    # blit is used to draw surfaces to the screen
...
def handle_bullets(yellow_bullets, red_bullets, yellow, red) -> None:
    for bullet in yellow_bullets:
        bullet.x += BULLET_VEL
        # only works if both objects are rectangles; returns True or False if two rects are collided
